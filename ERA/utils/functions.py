...
from ERA.utils import aiodownloader
from ERA.utils.dbfunctions import start_restart_stage
from ERA.utils.fetch import fetch
...
async def restart(m: Message):
    ...
    execvp(executable, [executable, "-m", "ERA"])
