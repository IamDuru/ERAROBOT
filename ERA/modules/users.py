...
import ERA.modules.no_sql.users_db as user_db
from ERA import DEV_USERS, LOGGER, OWNER_ID, dispatcher
from ERA.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from ERA.modules.helper_funcs.decorators import ERAcmd, ERAmsg
from ERA.modules.no_sql.users_db import get_all_users
...
@ERAcmd(command=["broadcastall", "broadcastusers", "broadcastgroups"])
@dev_plus
...
@ERAmsg((Filters.all & Filters.chat_type.groups), group=USERS_GROUP)
...
@ERAmsg((Filters.all & Filters.chat_type.groups), group=CHAT_GROUP)
