...
from ERA import BOT_NAME, BOT_USERNAME
from ERA import Durgesh as app

# MongoDB URL Pattern
mongo_url_pattern = re.compile(r'mongodb(?:\+srv)?:\/\/[^\s]+')

# MongoDB Checker Command
@app.on_message(filters.command("mongochk", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
...
async def gps(bot, message):
    ...
    try:
        geolocator = Nominatim(user_agent="legend-Durgesh")
...
@app.on_message(filters.command(["distance"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
