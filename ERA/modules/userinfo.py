...
import ERA.modules.sql.userinfo_sql as sql
from ERA import (
    DEV_USERS,
    INFOPIC,
    OWNER_ID,
...
from ERA import telethn as ERA
from ERA.__main__ import STATS, TOKEN, USER_INFO
from ERA.modules.helper_funcs.chat_status import sudo_plus
from ERA.modules.helper_funcs.decorators import ERAcallback, ERAcmd
from ERA.modules.helper_funcs.extraction import extract_user
from ERA.modules.no_sql.global_bans_db import is_user_gbanned
from ERA.modules.no_sql.users_db import get_user_num_chats
from ERA.modules.sql import SESSION
...
def info(update: Update, context: CallbackContext):
    ...
    try:
        if spamwtc := sw.get_ban(int(user.id)):
            ...
            text += "\nᴀᴘᴘᴇᴀʟ ᴀᴛ [sᴜᴘᴘᴏʀᴛ](https://t.me/Durgesh_V_SUPPORT)"
    except Exception:
...
@ERAcmd(command="stats", can_disable=True)
@sudo_plus
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + "\n\n[ᴍᴜꜱɪᴄ](https://t.me/EraVibesXbot)\n\n "
            + "🥀ʙʏ [ᴅᴜʀᴜ](https://t.me/OfficialDurgesh)\n",
            parse_mode=ParseMode.MARKDOWN,
