...
from ERA.modules.no_sql import ultrondb  as db
...
@Durgesh.on_message(filters.command("unpinall", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private)
...
@Durgesh.on_message(filters.command("antichannelpin", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private)
...
@Durgesh.on_message(filters.command("cleanlinked", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private)
...
@Durgesh.on_message(filters.command("permapin", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private)
...
@Durgesh.on_message(filters.linked_channel)
