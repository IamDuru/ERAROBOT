...
from ERA import OWNER_ID, dispatcher
...
def src(update, _):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](https://github.com).",
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
...
def wiki(update, context):
    ...
    if not str(Shinano[1]):
        ...
        try:
            ERA = update.effective_message.reply_text(
