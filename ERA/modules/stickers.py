...
async def handler(event):
    ...
    if "OfficialDurgesh" not in Credit:
...
async def drawText(image_path, text):
    ...
    fnt = "ariel.ttf" if os.name == "nt" else "./ERA/modules/resources/asu.ttf"
...
async def _(event):
    ...
    im1 = Image.open("ERA/modules/resources/blank_background.png")
    if ik.endswith(".tgs"):
