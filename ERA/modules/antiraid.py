...
from ERA.modules.cron_jobs import j
from ERA.modules.helper_funcs.anonymous import AdminPerms
from ERA.modules.helper_funcs.anonymous import resolve_user as res_user
from ERA.modules.helper_funcs.anonymous import user_admin as u_admin
from ERA.modules.helper_funcs.chat_status import connection_status, user_admin_no_reply
from ERA.modules.helper_funcs.decorators import ERAcallback, ERAcmd
...
@ERAcmd(command="raid", pass_args=True)
@connection_status
@loggable
...
@ERAcallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@ERAcallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@ERAcallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@ERAcmd(command="raidactiontime", pass_args=True)
@connection_status
@u_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
