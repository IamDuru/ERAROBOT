...
import ERA.modules.sql.language_sql as sql
from ERA.langs import get_language, get_languages, get_string
from ERA.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
...
@ERAcallback(pattern=r"setLang_")
@user_admin_no_reply
