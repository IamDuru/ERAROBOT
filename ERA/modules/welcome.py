...
import ERA.modules.sql.log_channel_sql as logsql
import ERA.modules.sql.welcome_sql as sql
from ERA import DEMONS, DEV_USERS, DRAGONS, LOGGER, OWNER_ID, EVENT_LOGS
from ERA import SUPPORT_CHAT as Dora_Hub
from ERA import WOLVES, dispatcher, sw
from ERA.modules.helper_funcs.anonymous import AdminPerms, user_admin
from ERA.modules.helper_funcs.chat_status import is_user_ban_protected
from ERA.modules.helper_funcs.chat_status import user_admin as u_admin
from ERA.modules.helper_funcs.decorators import ERAcallback, ERAcmd, ERAmsg
from ERA.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ERA.modules.helper_funcs.msg_types import get_welcome_type
from ERA.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from ERA.modules.log_channel import loggable
from ERA.modules.no_sql.global_bans_db import is_user_gbanned
...
@ERAmsg((Filters.status_update.new_chat_members), group=WELCOME_GROUP)
@loggable
...
@ERAmsg((Filters.status_update.left_chat_member), group=WELCOME_GROUP)
...
@ERAcallback(pattern=r"user_join_")
...
@ERAcallback(pattern=r"user_captchajoin_\([\d\-]+,\d+\)_\(\d{4}\)")
...
@ERAcmd(command="welcomehelp")
@u_admin
def welcome_help(update: Update, context: CallbackContext):
    update.effective_message.reply_text(WELC_HELP_TXT, parse_mode=ParseMode.MARKDOWN)


@ERAcmd(command="welcomemutehelp")
@u_admin
...
@ERAcallback(pattern=r"wlc_help_")
