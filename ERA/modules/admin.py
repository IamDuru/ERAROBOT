...
from ERA import Durgesh, dispatcher
from ERA import telethn as bot
...
@Durgesh.on_message(filters.command(["adminlist", "staff", "admins"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
async def admins(client, message):
    try:
        adminList = []
        ownerList = []
        async for admin in Durgesh.get_chat_members(
        ...
        await Durgesh.send_message(message.chat.id, text2)
    except FloodWait as e:
        await asyncio.sleep(e.value)


@Durgesh.on_message(filters.command("bots", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
async def bots(client, message):
    try:
        botList = []
        async for bot in Durgesh.get_chat_members(
        ...
        await Durgesh.send_message(message.chat.id, text3)
    except FloodWait as e:
        await asyncio.sleep(e.value)
