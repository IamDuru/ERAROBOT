...
@ERAcmd(command="setrules", filters=Filters.chat_type.groups)
...
@ERAcmd(command="clearrules", filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
