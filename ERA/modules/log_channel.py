...
from ERA.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from ERA import EVENT_LOGS, LOGGER, dispatcher
    ...
    from ERA.modules.sql import log_channel_sql as sql
...
@ERAcallback(pattern=r"log_tog_.*")
