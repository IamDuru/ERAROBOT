...
from ERA import DRAGONS, LOGGER, TIGERS, WOLVES
...
from ERA.modules.sql import reporting_sql as sql
...
@ERAcmd(command="report", filters=Filters.chat_type.groups, group=REPORT_GROUP)
@ERAmsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
