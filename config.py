...
class Config(object):
    ...
    DB_NAME = getenvDB_NAME", "AvaRobot")
    REDIS_URL = getenv("REDIS_URL", "redis://default:K6ZCiclq4iQKYpgfY90v6kd6WdPfEwl@redis-10186.c263.us-east-1-2.ec2.cloud.redislabs.com:10186/default")
